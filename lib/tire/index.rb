module Tire
  class Index
    ...
    def percolate(*args, &block)
      ...
      payload["highlight"] = {"order" => "score", "pre_tags" => ["<strong class='highlight'>"], "post_tags" => ["</strong>"], "require_field_match" =>  true, "fields" => {"title" => {}, "html_source" => {"fragment_size" => 150, "number_of_fragments" => 2}, "popular_hash_tags" => {}}  }
      payload["size"] = 1000
